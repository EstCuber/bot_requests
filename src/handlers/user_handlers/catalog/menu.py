...
async def help_handler(
    ...
    await message.answer(_("Если у вас появились вопросы, то пожалуйста, задайте свой вопрос! Пожалуйста, проверьте свои настройки конфидициальности для отправки сообщения! "
